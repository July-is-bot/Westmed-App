...
//      provider.specialty.forEach((specialty, index) => {
//        document.getElementsByClassName("specialty")[index].addEventListener("click", function () {
//          document.getElementsByClassName("common-symptoms")[index].classList.toggle("open");
//        });
//      });
