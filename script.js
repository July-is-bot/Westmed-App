...
let allSpecialties = ["not defined", "cardiology", "dermatology", "endocrinology", "gastroenterology", "internalmedicine", "nephrology", "neurology", "oncology", "physicaltherapy", "pulmonology", "rheumatology", "vascular", "weightmanagement", "chiropractics", "allergy", "bariatricsurgery"];
...
const displaySearchResults = (results) => {
    ...
    if (results.length === 0) {
        ...
        results.forEach((provider) => {
            ...
            providerCard.style.borderBottom = "black solid 1px"
            ...
            neurologyIcon = document.createElement("div");
            ...
            const specialtyIconsArray = [internalMedicineIcon, gastroenterologyIcon, neurologyIcon, pulmonologyIcon, physicalTherapyIcon, endocrinologyIcon, rheumatologyIcon, cardiologyIcon, dermatologyIcon, nephrologyIcon, vascularIcon];
            ...
            cardHeaderRow1.style.display = "flex";
            cardHeaderRow1.style.gap = "0.4rem";
            cardHeaderRow1.style.flexDirection = "row";
            ...
            providerSpecialty.classList.add("specialty");
            providerSpecialty.textContent = formatSpecialtyName(provider.specialty);
            cardHeaderRow2.appendChild(providerSpecialty);
