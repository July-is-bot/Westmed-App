...
export function displaySearchResults(results, page = 1, resultsPerPage = 10) {
    ...
    if (results.length === 0) {
        ...
        // Loop through the results for the current page and create a card for each provider using the static ProviderCard method
        const pageResults = results.slice(startIndex, endIndex);
        pageResults.forEach((provider) => {
