...
export function csvToJson(csv) {
    ...
    console.log("Line headers are: " + headers + " and the type is " + typeof headers + " and the length is " + headers.length);
    const result = [];
...
export async function importProviderData(csvFile) {
    ...
    console.log("CSV data is: " + csvData + " and the type is " + typeof csvData + " and the length is " + csvData.length);
    const jsonData = csvToJson(csvData);
    jsonData.forEach(provider => {
        console.log(provider);
        console.log("The type of the provider is " + typeof provider)
    });
